	...
	const headerLinks = computed(() => {
		return [
			...
			},
			{
				...
				to: '/docs',
				search: false,
				active: route.path.startsWith('/docs') || route.path.startsWith('/getting-started') || route.path.startsWith('/guide') || route.path.startsWith('/api') || route.path.startsWith('/examples') || route.path.startsWith('/community'),
				children: [
					{
						label: 'Get Started',
